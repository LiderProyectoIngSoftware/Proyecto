...
public class EnviadorCorreos {
    ...
    public static void main(String[] args) {
        ...
        data.add("por cierto nos gusta distribuir tu password a lo wey , y es asdasd");
        EnviadorCorreos enviador = new EnviadorCorreos();
        enviador.sendMail(new String[]{"esquivel.vega.alberto@gmail.com"}, "Correo RedSocial", data);

    }

    public EnviadorCorreos() {
        Properties map = obtenerPropiedadesCorreo();
    ...
    private String obtenerHTML(List<String> cuerpo) {
    ...
    public boolean sendMail(String[] destinatarios, String subject, List<String> mensaje) {
        try {
    ...
    private Properties obtenerPropiedadesCorreo() {
